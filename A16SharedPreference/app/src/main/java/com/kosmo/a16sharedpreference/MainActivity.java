...
public class MainActivity extends AppCompatActivity {
    ...
    /*
    * SharedPreferences
        : 해당 어플리케이션에서 저장하고 싶은 데이터가 있을 때
            단말기에 파일 형태로 보관해주는 기능을 제공한다.
        : 해당 파일은 앱이 삭제되기 전까지 유지되고, 삭제될때 파일도 같이 삭제된다.
        : 자동로그인, 게임스코어유지, 앱의 마지막상태 저장 등에 사용된다.     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        - MODE_PRIVATE : 본인의 앱에서만 사용하도록 설정하는 기본값.         */
        ...
        - 만약 저장된 값이 없을 경우에는 디폴트값으로 두번쨰 인자에 저장된 값을 사용한다.         */
   ...
   public void btnLoginClicked(View v){
        ...
        Toast.makeText(getApplicationContext(), "로그인 정보 저장됨", Toast.LENGTH_SHORT).show();
    }
}